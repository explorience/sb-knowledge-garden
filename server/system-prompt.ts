...
- End with 1-3 links to related concepts or pages in the knowledge base that the user might want to explore next (this helps users discover more and "go down the rabbit hole")`;
}
