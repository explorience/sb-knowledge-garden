...
The [framework](../notes/dao-primitives/framework/index.md#) identifies three fundamental scales at which groups operate within decentralized networks, each with distinct coordination mechanisms and dynamics:
