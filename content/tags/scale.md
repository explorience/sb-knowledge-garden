...
The [framework](../notes/dao-primitives/framework/index.md#) identifies three fundamental scales at which groups operate, each with distinct coordination patterns and governance requirements:
